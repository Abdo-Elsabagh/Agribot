                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  fontSize: 20, color: Colors.teal[400]),
                            ),
                            const SizedBox(
                              height: 30,
                            ),
                                  ...
                                  if (formKey.currentState!.validate()) {
                                    ...
                                    try {
                                      ...
                                      var response = await Dio().post(
                                          'https://agribotapi.onrender.com/api/auth/local/register',
                                          data: {
                                            "username": usernamee.toString(),
                                            "email": email.toString(),
                                            "password": passwoord.toString()
                                          });
                                      if (response.statusCode == 200) {
                                        reguser = RegisterData.fromjson(
                                            response.data);
